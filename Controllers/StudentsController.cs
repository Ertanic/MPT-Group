    ...
    public class StudentsController : ControllerBase
    {
        ...
        public async Task<ActionResult<IEnumerable<Student>>> GetStudents()
        {
            return await _context.Students
                ...
                .Include(s => s.LikedSubject)
                .Include(s => s.Photo)
                .Include(s => s.LikedTeacher)
        ...
        [HttpGet("{filter}")]
        public async Task<ActionResult<IEnumerable<Student>>> GetStudents(string filter)
        {
            var student = filter == "active"
                ? await _context.Students
                    ...
                    .Include(s => s.LikedTeacher)
                        .ThenInclude(t => t.Photo)
                    .Include(s => s.Photo)
                    .Where(s => s.Function.Name != "Студент").ToListAsync()
